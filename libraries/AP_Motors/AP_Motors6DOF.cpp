...
void AP_Motors6DOF::setup_motors(motor_frame_class frame_class, motor_frame_type frame_type)
{
    ...
    case SUB_FRAME_CUSTOM:
        ...
        add_motor_raw_6dof(AP_MOTORS_MOT_1,     0,              1,              0,              1,              0,              0,              1);
        add_motor_raw_6dof(AP_MOTORS_MOT_2,     0,              0,              1,              0,              1,              1,              2);
        add_motor_raw_6dof(AP_MOTORS_MOT_3,     0,              0,              -1,             0,              1,              1,              3);
        add_motor_raw_6dof(AP_MOTORS_MOT_4,     1,             -1,              0,              0.7,            0.7,            0.7,            4);
        add_motor_raw_6dof(AP_MOTORS_MOT_5,     -1,            -1,              0,              0.7,            0.7,            -0.7,           5);
        add_motor_raw_6dof(AP_MOTORS_MOT_6,     -1,             1,              0,              -0.7,           0.7,            0.7,            6);
        add_motor_raw_6dof(AP_MOTORS_MOT_7,     1,              1,              0,              -0.7,           0.7,            -0.7,           7);
        break;
        //break;
